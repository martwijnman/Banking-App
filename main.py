...
def showNewPage():
    ...
    def addListFile():
        ...
        name = tk.Label(nextpage2frame, text="Name:", fg=bgcolor)
        name.pack(pady=5)
        UIproduct = Entry(nextpage2frame)
        UIproduct.pack()
        price = tk.Label(nextpage2frame, text="Price:", fg=bgcolor)
        price.pack(pady=5)
        UIprice = Entry(nextpage2frame)
        UIprice.pack()
        code = tk.Label(nextpage2frame, text="Code:", fg=bgcolor)
        code.pack(pady=5)
    ...
    def removeListFile():
        ...
        nextpage2frame = ttk.Frame(root)
        nextpage2frame.pack(expand=True, fill="both")
        name = tk.Label(nextpage2frame, text="Name:", bg=fgcolor)
        name.pack(pady=5)
        UIproduct = Entry(nextpage2frame)
        UIproduct.pack()
        price = tk.Label(nextpage2frame, text="Price:", bg=fgcolor)
        price.pack(pady=5)
        UIprice = Entry(nextpage2frame)
        UIprice.pack()
        code = tk.Label(nextpage2frame, text="Code:", fg=bgcolor)
